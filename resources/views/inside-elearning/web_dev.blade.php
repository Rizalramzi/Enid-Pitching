...
<head>
    ...
    <title>Web Development | Learnifie</title>
</head>
<body>
        ...
        <div class="container">
            <div class="row justify-content-center align-item-center">
                <div class="col-md-6 mt-3 text-center" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="500">
                    <img src="../material/icon/web-dev-icon.png" alt="" width="250">
                </div>
                <div class="col-md-6 mt-5">
                <h2 style="color: #045B53;"data-aos="fade-up"
                data-aos-anchor-placement="top-bottom" data-aos-duration="500"><b>Web Development</b></h2>
                <p data-aos="fade-up"
                data-aos-anchor-placement="top-bottom" data-aos-duration="500">5 Topics 30 Materials</p>
