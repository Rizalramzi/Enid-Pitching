...
<head>
    ...
    <title>Artifical Intelligence | Learnifie</title>
</head>
<body>
        ...
        <div class="container">
            <div class="row justify-content-center align-item-center">
                <div class="col-md-6 mt-3 text-center" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="500">
                    <img src="../material/icon/ai-icon.png" alt="" width="250">
                </div>
                <div class="col-md-6 mt-5">
                <h2 style="color: #045B53;"data-aos="fade-up"
                data-aos-anchor-placement="top-bottom" data-aos-duration="500"><b>Artificial Intelligence</b></h2>
                <p data-aos="fade-up"
                data-aos-anchor-placement="top-bottom" data-aos-duration="500">6 Topics 34 Materials</p>
                <p class="mt-3"data-aos="fade-up"
                data-aos-anchor-placement="top-bottom" data-aos-duration="700">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam</p>
